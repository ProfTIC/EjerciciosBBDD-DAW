DROP DATABASE IF EXISTS act32_1_FJGM;
...
CREATE TABLE Adquisición (
	...
	CONSTRAINT Adquisición_Ref_FK 
	FOREIGN KEY (Ref) 
	REFERENCES Regalo(Ref)
	ON UPDATE CASCADE
	ON DELETE NO ACTION,
	CONSTRAINT Adquisición_NIF_FK 
	FOREIGN KEY (NIF) 
	REFERENCES Invitado(NIF)
	ON UPDATE CASCADE
	ON DELETE NO ACTION
);
